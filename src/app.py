...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill-building and friendly games on the court",
    ...
    "Science Olympiad": {
        "description": "Compete in science, technology, engineering, and math challenges",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["amelia@mergington.edu", "elijah@mergington.edu"]
    },
    "Debate Team": {
        "description": "Learn argumentation and public speaking for debate competitions",
